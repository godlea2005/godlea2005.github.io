...
Final branch scoped re-review: APPROVED (F1 project deletion race RESOLVED; F2 server project validation/direct grants RESOLVED; F3 idempotent admin refund/concurrency RESOLVED; F4 zero-byte validation RESOLVED; 0 Critical / 0 Important / 0 Minor; focused 89/89, full 237/237, strict TypeScript and diff-check clean; live infrastructure gates remain pending).
