...
export function ProjectArchive() {
  return (
    <section className="archive-section frame" id="archive" aria-labelledby="archive-title">
      <div className="section-kicker"><span>02</span><p>SELECTED ARCHIVE</p><i /></div>
      <div className="archive-title-row"><h2 id="archive-title">精选项目</h2><p>一些围绕品牌、内容与体验的工作切片。</p></div>
